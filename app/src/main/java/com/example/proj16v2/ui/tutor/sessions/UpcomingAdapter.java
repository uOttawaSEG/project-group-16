...
public class UpcomingAdapter extends RecyclerView.Adapter<UpcomingAdapter.VH> {
    ...
    public interface OnCancel { void cancel(long sessionId); }
    ...
    public UpcomingAdapter(OnCancel onCancel) { this.onCancel = onCancel; }
    ...
    @Override public void onBindViewHolder(@NonNull VH h, int pos) {
        ...
        // Cancel button is optional — only wire if present in the layout
        if (h.btnCancel != null) h.btnCancel.setOnClickListener(v -> onCancel.cancel(it.id));
    }
    ...
    static class VH extends RecyclerView.ViewHolder {
        ...
        Button btnCancel; // optional
        VH(View v) {
            super(v);
            line1 = v.findViewById(R.id.tvLine1);
            line2 = v.findViewById(R.id.tvLine2);
            btnCancel = v.findViewById(R.id.btnCancel); // may be null if not in layout
        }
    }
}
